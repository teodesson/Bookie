...
class AdminApiTest(unittest.TestCase):
    ...
    def test_invite_ct(self):
        ...
        self.assertTrue(found, "There should be the admin user." + res.unicode_body)
        self.assertEqual(
            0,
            invite_count,
    ...
    def test_set_invite_ct(self):
        ...
        self.assertEqual(
            'admin',
            data.get('username'),
            "The admin user data is returned to us." + str(res.unicode_body))
        self.assertEqual(
            10,
    ...
    def test_import_info(self):
        ...
        self.assertEqual(
            1, data.get('count'), "There are none by default. " + res.unicode_body)
