...
class BookieAPITest(unittest.TestCase):
    ...
    def test_account_information(self):
        ...
        url = u'/api/v1/admin/account?api_key=' + API_KEY
        print('test_account_information_url: ' + url)
    ...
    def test_account_apikey(self):
        ...
        url = u"/api/v1/admin/api_key?api_key=" + str(API_KEY)
        #print('test_account_apikey_url: ' + url)
        res = self.testapp.get(url, status=200)

        # make sure we can decode the body
        str_body = res.unicode_body
        print('test_account_apikey_body: ' + str_body)
        user = json.loads(str_body)
    ...
    def test_account_password_change(self):
        ...
        url = "/api/v1/admin/password?api_key=" + str(API_KEY)
        print('test_account_password_change_url: ' + url)
        res = self.testapp.post(
            url,
            params=params,
            status=200)
